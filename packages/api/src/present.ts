...
export function presentMetrics(row: MetricsRow) {
  return {
    ...
    betaBtc: trimNumeric(row.betaBtc),
    betaEth: trimNumeric(row.betaEth),
    betaSol: trimNumeric(row.betaSol),
    rSquaredBtc: trimNumeric(row.rSquaredBtc),
    rSquaredEth: trimNumeric(row.rSquaredEth),
    rSquaredSol: trimNumeric(row.rSquaredSol),
